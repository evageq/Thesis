...
Точки присутствия и склады имеет отностельно маленькое количество людей, 
поэтому настройка VLAN и STP для данных объектов предприятия может быть опущена.
